...
for i in range(iter):
    file_lasso = open("predictionsProb_ism_svmlinear" + str(i) + ".csv").readlines()
    file_nw = open("predictionsProb_ism_rf" + str(i) + ".csv").readlines()
    ...
    np.savetxt('pp_rf_svmlinear_ensemble_chap2' + str(i) + '.csv', ensembles[countlist[ind]-1], delimiter=',')
