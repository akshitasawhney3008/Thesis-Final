...
for i in range(iter):
    X_train = np.load('transformed_train_data_' + str(i) + '.npy')
    Y_train = np.load('transformed_train_labels_' + str(i) + '.npy')
    X_test = np.load('transformed_test_data_' + str(i) + '.npy')
    Y_test = np.load('transformed_test_labels_' + str(i) + '.npy')
